...
import booking.bus.trains.hotel.flight.deals.travel.smarttraveller.Listeners.RecyclerItemClickListener;
...
public class MainActivity extends AppCompatActivity
    ...
    private void SearchView(){
        Intent intent = new Intent(MainActivity.this, WebsiteVisit.class);
        String term = googleSearchEditText.getText().toString();
        intent.putExtra("googlequery",url+term);
        startActivity(intent);
    }
...
private void loadDeals(){
    ...
    private void initViews(){
     //   recyclerView.setHasFixedSize(true);
        ...
        dealsAdapter = new DealsAdapter(MainActivity.this,MainActivity.this, dealArrayList);
